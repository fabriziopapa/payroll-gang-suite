  ...
  apps: [
    {
      ...
      // radice del repo: nessun percorso da adattare.
      // NB: aaPanel riscrive questa riga quando si salva il progetto dal
      // pannello e cancella i commenti in coda -> tenerlo qui sopra, altrimenti
      // ogni deploy trova l'albero sporco e pgs-update-aapanel.sh si ferma.
      cwd:              __dirname,
      instances:        1,
