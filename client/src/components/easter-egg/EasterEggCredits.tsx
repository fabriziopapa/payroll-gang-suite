...
const PARAGRAPHS: string[] = [
  'Ad Alessio.',
  '',
  'Ci sono persone che entrano nella tua vita\ne lasciano qualcosa di permanente\nsenza nemmeno saperlo.',
  '',
  'Questo lavoro nasce anche da te —\ndalla tua curiosità,\ndal tuo modo di vedere le cose,\ndal tempo che hai condiviso.',
  '',
  'Non so se un giorno leggerai questo.\nMa se succede, sappi\nche sei stato parte di qualcosa\nche conta.',
  '',
  '— F.',
]
