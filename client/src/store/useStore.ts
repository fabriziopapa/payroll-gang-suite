    ...
    addDettaglio: (partial) => {
      ...
      set(s => {
        ...
        const det: DettaglioLiquidazione = {
          ...
          // Provvedimento: nuovi gruppi nascono senza dati (identificativo XOR
          // estremi si decide nel form). Il tipo si precompila all'inserimento
          // del numero, non alla creazione.
          identificativoProvvedimento: partial?.identificativoProvvedimento ?? '',
          tipoProvvedimento:           partial?.tipoProvvedimento           ?? '',
