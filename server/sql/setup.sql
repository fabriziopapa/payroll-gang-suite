-- ============================================================
-- PAYROLL GANG SUITE — Setup Database PostgreSQL
-- Prima installazione — eseguire come superuser:
--   psql -U postgres -f setup.sql
-- ============================================================

-- ------------------------------------------------------------
-- Utente applicazione (least privilege)
-- Cambia la password prima di eseguire in produzione.
-- ------------------------------------------------------------
DO $$
BEGIN
  IF NOT EXISTS (SELECT FROM pg_roles WHERE rolname = 'payroll_user') THEN
    CREATE ROLE payroll_user WITH LOGIN PASSWORD 'CAMBIA_CON_PASSWORD_SICURA';
  END IF;
END $$;
