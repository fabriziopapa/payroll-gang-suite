...
// Provider e dominio configurati via env (SMTP_HOST, SMTP_USER, MAIL_FROM)
//
// Requisiti reputazione (da configurare sul DNS del proprio dominio):
//   SPF  : record che autorizza il provider SMTP scelto
//   DKIM : firma gestita dal provider SMTP
//   DMARC: policy consigliata p=reject
//   From : deve essere sul dominio allineato a SPF/DKIM per il DMARC
// ============================================================
